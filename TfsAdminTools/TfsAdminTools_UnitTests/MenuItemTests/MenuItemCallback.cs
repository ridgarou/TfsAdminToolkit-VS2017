...
using mskold.TfsAdminTools;

namespace TfsAdminTools_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TfsAdminToolsPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(mskold.TfsAdminTools.GuidList.guidTfsAdminToolsCmdSet, (int)mskold.TfsAdminTools.PkgCmdIDList.cmdidMyCommand);
