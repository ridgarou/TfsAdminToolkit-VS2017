...
namespace TfsAdminTools_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(mskold.TfsAdminTools.GuidList.guidTfsAdminToolsCmdSet, (int)mskold.TfsAdminTools.PkgCmdIDList.);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "TfsAdminTools", "mskold.TfsAdminTools.TfsAdminToolsPackage");
